...
/**
 * A view with a table for all the vehicles
...
public class Overview extends JFrame {
	...
	public Overview(){
		...
		editButton.setToolTipText("Bewerk het geselecteerde voertuig");
		...
		deleteButton.setToolTipText("Verwijder het geselecteerde voertuig");
